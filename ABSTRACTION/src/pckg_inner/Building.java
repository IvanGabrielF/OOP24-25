...
public class Building {
    ...
    public final void getSomeFloorInfo(){
    ...
    public void specialLocalBuildingFeature(){
        class BuildingCompanyService{
            ...
            void performServiceOnBuilding(){
                System.out.println("Performing maintance on: " + street);

            }
        }
        BuildingCompanyService buildingCompanyService = new BuildingCompanyService("SV", "-CRO");
        buildingCompanyService.performServiceOnBuilding();
